...
import { changeStatus } from '../../../../../UtiFunctions/admin';
...
function AdminContentRow({arg,userToken}) {
    ...
    const handleChange = async(e, id) => 
    {
        ...
        changeStatus(id,e.target.value,userToken)
  ...
  return (
    <>
        ...
        <TableRow sx={{ '& > *': { borderBottom: 'unset' },backgroundColor:"#edf4f4" }}>
                ...
                <TableCell>{<p> {arg.orderdBy.email} <br/>{arg.orderdBy.name} </p>}</TableCell>
                ...
                <TableCell align="right">
                     ...
                     <Select
                        ...
                        defaultValue={arg.orderStatus}
                        className={arg.orderStatus}
                        onChange={(e)=>{handleChange(e,arg._id)}}
                ...
                <TableCell align="right">
                    {((props)=>console.log("props in the select",props))()}
